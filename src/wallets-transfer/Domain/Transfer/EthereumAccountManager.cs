...
public class EthereumAccountManager
{
    ...
    public EthereumAccountManager(BlockchainConnections blockchainConnections, ILogger<EthereumAccountManager> logger)
    {
        BlockchainUrl = blockchainConnections.DefaultConnection;
        _logger = logger;
